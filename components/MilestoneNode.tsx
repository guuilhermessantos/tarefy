...
const MilestoneNode = ({ id, data, selected }: NodeProps<MilestoneNodeData>) => {
  ...
  return (
    <motion.div
      ...
      className={`floating-card group relative min-w-[200px] p-4 bg-gradient-to-br from-[#7B61FF]/20 to-[#7B61FF]/10 border-2 border-[#7B61FF] ${
        selected ? 'ring-2 ring-[#7B61FF]' : ''
      }`}
    ...
    >
      <Handle
        ...
        className="!h-2 !w-2 !bg-[#7B61FF] !border-2 !border-background"
      />
      <Handle
        id="target-left"
        type="target"
      ...
      <div className="flex items-center gap-3">
        <div className="flex-shrink-0">
          <Flag className="h-6 w-6 text-[#7B61FF]" />
        </div>
